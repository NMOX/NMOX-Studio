...
/**
 * The KVASIR "explain this" seam, published by the rack module and looked
...
public interface KvasirAsk {
     ...
     */
    static KvasirAsk find() {
        return Lookup.getDefault().lookup(KvasirAsk.class);
    }
    ...
    record Disclosure(String kind, String title, String what, String body, String question) {
        ...
        public Disclosure {
            ...
            title = title == null || title.isBlank() ? "KVASIR" : title;
            what = what == null ? "" : what;
            body = body == null ? "" : body;
    ...
    /**
     * Opens an KVASIR conversation about this disclosure, prompting for
