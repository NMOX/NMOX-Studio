...
import org.nmox.studio.core.spi.OracleAsk.Disclosure;

import static org.assertj.core.api.Assertions.assertThat;

/**
 * The seam's guarantees to every studio that reaches ORACLE through it.
...
class OracleAskTest {
    ...
    void titleFallsBack() {
        assertThat(new Disclosure("k", null, "w", "b", "q").title()).isEqualTo("ORACLE");
        assertThat(new Disclosure("k", "", "w", "b", "q").title()).isEqualTo("ORACLE");
    }
