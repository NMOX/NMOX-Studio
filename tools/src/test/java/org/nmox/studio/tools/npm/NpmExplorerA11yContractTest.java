...
/**
 * The rack's name law (v1.41.0, DeviceContractTest) over the NPM Explorer (v2.75.0):
 ...
 */
class NpmExplorerA11yContractTest {
    ...
    void everyButtonIsNamed() throws Exception {
        ...
        SwingUtilities.invokeAndWait(() -> {
            for (Container window : List.<Container>of(new NpmExplorerTopComponent())) {
