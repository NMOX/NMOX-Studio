...
Za nią `↑2 ↓1` to commity, które ma twoja gałąź, a nie ma jej upstream (do wypchnięcia), i odwrotnie (do pobrania); pokazują się tylko wtedy, gdy nie są zerowe, i tylko dla gałęzi z upstreamem. Jej menu zaczyna się od **Przełącz gałąź…** i **Zatwierdź…**, własnych okien modułu git.
