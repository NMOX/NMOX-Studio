...
Di samping tanda itu, sebuah catatan yang lebih tenang menjawab pertanyaan yang paling sering Anda ajukan: siapa yang menulis baris tempat kursor berada? `Ada Lovelace, 3 hari yang lalu · Fix the parser` mengikuti kursor, dalam bahasa Anda, dan tooltip-nya menyebut commit dan tanggalnya. Sekali klik membuka anotasi seluruh berkas — **Anotasi** yang sama yang ditawarkan tanda itu. Catatan ini bertanya kepada git sekali untuk tiap versi berkas yang tersimpan, tidak pernah saat mulai dan tidak pernah untuk berkas di luar repositori, dan diam untuk berkas yang tidak dilacak git. Baris yang Anda ubah tetapi belum di-commit berbunyi **Belum di-commit**. Selama berkas punya perubahan yang belum disimpan, catatannya berbunyi **Penulis baris: ada perubahan yang belum disimpan** alih-alih sebuah nama, karena git membaca berkas sebagaimana tersimpan, dan baris 40 di layar belum tentu baris 40 di cakram; simpan, dan namanya kembali. **Tampilan ▸ Penulis baris** mematikan dan menyalakan catatan itu.
