...
Sesudahnya, `↑2 ↓1` adalah commit yang dimiliki cabang Anda tetapi tidak dimiliki upstream-nya (untuk di-push) dan sebaliknya (untuk di-pull), hanya ditampilkan bila bukan nol dan hanya untuk cabang yang punya upstream. Menunya diawali dengan **Ganti Branch…** dan **Commit…**, dialog milik modul git sendiri.
