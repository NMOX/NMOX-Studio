...
Dahinter stehen mit `↑2 ↓1` die Commits, die Ihr Zweig hat und sein Upstream nicht (zum Pushen), und umgekehrt (zum Pullen) — nur angezeigt, wenn sie nicht null sind, und nur für einen Zweig mit Upstream. Sein Menü beginnt mit **Branch wechseln…** und **Commit…**, den eigenen Dialogen des Git-Moduls.
