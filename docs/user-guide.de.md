...
Unter macOS verwenden Sie `nmox .` oder **Datei ▸ Ordner öffnen…**. *Öffnen mit* im Finder und das Dock-Symbol können einer signierten Java-App, die so gestartet wird wie NMOX Studio, keinen Ordner übergeben; deshalb bietet sich die App dort nicht an.
