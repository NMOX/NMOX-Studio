...
Depois dele, `↑2 ↓1` são os commits que o seu ramo tem e o upstream dele não tem (para enviar) e o contrário (para trazer), mostrados só quando não são zero e só para um ramo com upstream. O menu dele começa com **Trocar de branch…** e **Fazer commit…**, os próprios diálogos do módulo git.
