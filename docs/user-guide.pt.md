...
**Ajuda ▸ Site do NMOX Studio (local)** serve o site do produto a partir do próprio rack dele, na interface local. Ele fala as mesmas catorze línguas que a IDE; o seletor fica no rodapé.
