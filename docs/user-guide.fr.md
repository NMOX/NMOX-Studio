...
Après elle, `↑2 ↓1` sont les commits que votre branche a et que son amont n’a pas (à pousser), et l’inverse (à tirer), affichés seulement s’ils ne sont pas nuls et seulement pour une branche qui a un amont. Son menu commence par **Changer de branche…** et **Valider…**, les boîtes de dialogue du module git lui-même.
