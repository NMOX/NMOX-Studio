...
Sous macOS, utilisez `nmox .` ou **Fichier ▸ Ouvrir un dossier…**. Le *Ouvrir avec* du Finder et l’icône du Dock ne peuvent pas confier un dossier à une application Java signée lancée comme l’est NMOX Studio ; l’application ne s’y propose donc pas.
