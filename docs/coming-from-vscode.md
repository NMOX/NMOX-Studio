...
| **Problems panel** | **Action Items** (⌘6): the language servers' errors and warnings, and the lint and type findings from the rack's PURITY and TYPEGUARD devices. A language server reports on the files it has open, as in VS Code. |
