...
En macOS, usa `nmox .` o **Archivo ▸ Abrir carpeta…**. El *Abrir con* del Finder y el icono del Dock no pueden pasarle una carpeta a una app Java firmada que arranca como arranca NMOX Studio, así que la app no se ofrece ahí.
