...
Tras él, `↑2 ↓1` son los commits que tiene tu rama y no su upstream (para enviar) y al revés (para traer), y solo aparecen cuando no son cero y en una rama con upstream. Su menú empieza con **Cambiar de rama…** y **Confirmar…**, los propios diálogos del módulo git.
