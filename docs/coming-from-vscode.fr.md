...
| **`settings.json`** | Outils ▸ Options (sous macOS, NMOX Studio ▸ Settings…). Le `.editorconfig` de votre projet s’applique pendant la frappe et à l’enregistrement. |
