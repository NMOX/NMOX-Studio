...
![راك المهام: رف الأجهزة على الشمال هو المكان اللي بيظهر فيه أي جهاز من ~/.nmox/devices.d، جنب الأجهزة المدمجة](../images/tabs/the-task-rack.png)
...
بيعمل، والأحمر بيوقف)، والمنفذين بيخلّوه ينفع يتوصّل.
...
قرّبوا الماوس على كارت «طريقة الاستخدام» بتاعه — ده نص `usage` بتاعكم،
...
اسحبوا كابل من **OUT** في COUNTER لـ **TAP** في MONITOR. دوسوا COUNT
