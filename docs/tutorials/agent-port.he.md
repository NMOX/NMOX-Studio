...
![תיבת הדו‑שיח של ה‑Agent Port — נקודת הגישה ב‑loopback, האסימון שנוצר בכל הפעלה (בצילום הזה, ממלא מקום) ותצורת הלקוח המוכנה להעתקה](../images/tabs/agent-port.png)
...
**עשו:** כלים ‏◂‏ **Agent Port ‏(MCP)…** ‏◂‏ **הפעלה**, ואז **העתקת התצורה**.
