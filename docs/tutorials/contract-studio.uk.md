...
![ANVIL працює в стійці, а Студія контрактів сама до нього підключилася — ланцюг 31337, контракт у дереві артефактів із використанням розміру за EIP-170](../images/contract-studio.png)
