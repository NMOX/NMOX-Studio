...
![एक SQLite कनेक्शन, एक क्वेरी, ग्रिड में जीवित पंक्तियाँ — और ग्रिड केवल-पढ़ने योग्य होने पर स्थिति-पट्टी पर ईमानदार कारण](../images/db-studio.png)
...
1. **SQLite कनेक्शन बनाएँ।** **नया कनेक्शन** पर क्लिक करें, **SQLite**
...
4. **निर्यात करें।** किसी भी ग्रिड पर राइट-क्लिक करें → **CSV के रूप में
   निर्यात करें / JSON के रूप में निर्यात करें**। CSV निर्यात स्प्रेडशीट के
