...
![प्रेज़ेंटेशन मोड चालू: एक Angular टेम्पलेट और Output विंडो दोनों +10 pt पर, मोड बंद करते ही ठीक पहले जैसे](../images/presentation-mode.png)

![अकेला एडिटर टैब, एडिटर स्क्रीनशॉट सेव करें… से 2x पर सेव किया हुआ](../images/editor-screenshot-2x.png)
