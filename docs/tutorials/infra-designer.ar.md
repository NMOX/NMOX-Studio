...
![ستاك بيتشكّل — DNS، وموزّع حمل، وdroplet، وvolume ومعاه لوحة الخصائص بتاعته؛ شريط الأدوات بيحسب سعر التصميم على الهوا وبيقول بصراحة إنه في الوضع التجريبي](../images/infra-designer.png)
...
5. **شغّلوه بجد (لما تكونوا جاهزين).** ضيفوا توكن المزوّد في `الخيارات`
   (بيتخزن في سلسلة مفاتيح النظام)، و**نشر** بينفّذ الخطة بجد، وبيحل
