...
![बाएँ डॉक में वर्कबेंच — टूलचेन चिप्स के साथ मौजूदा प्रोजेक्ट, खुली और हालिया फ़ाइलें, प्रोजेक्ट और टूलिंग की सूची](../images/tabs/workbench.png)
...
1. **देखें कि आप कहाँ हैं।** **मौजूदा प्रोजेक्ट** स्तंभ लक्षित प्रोजेक्ट
...
3. **प्रोजेक्ट बदलें।** **प्रोजेक्ट** स्तंभ वह सब दिखाता है जिसे NMOX
   Studio जानता है। किसी एक पर क्लिक करके उसे लक्षित करें — रैक,
   एक्सप्लोरर और हालिया सूची, सब उसी प्रोजेक्ट के साथ चलते हैं।

4. **अपना टूलिंग जाँचें।** **टूलिंग** स्तंभ वे स्टूडियो और बाहरी उपकरण
   दिखाता है जिन तक आप पहुँच सकते हैं। लगभग 60 बाहरी उपकरणों की संस्करण
