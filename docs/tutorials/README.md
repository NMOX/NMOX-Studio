...
For the wide reference (install, every menu, every safety net) see the
[User Guide](../user-guide.md). For the full device list see
...
| [Infra Designer](infra-designer.md) | Draw a droplet + firewall and dry-run the deploy | ⌥⌘9 |
