...
![KVASIR объясняет реальный упавший запуск: диагноз после согласия на лицевой панели и полные шаги исправления в окне просмотра](../images/kvasir-explain.png)
...
4. **Прочтите вердикт.** Краткий диагноз появляется на многострочном
   ЖК-экране; полное объяснение открывается во всплывающем окне. Ручка
