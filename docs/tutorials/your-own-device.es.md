...
![El Rack de tareas: el estante de dispositivos de la izquierda es donde aparece un dispositivo de ~/.nmox/devices.d, junto a los integrados](../images/es/tabs/the-task-rack.png)
