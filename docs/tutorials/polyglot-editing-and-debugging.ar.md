...
![نقطة توقف في JavaScript اتوصلها: التنفيذ واقف، ومكدّس استدعاءات Node، ومتغيرات V8 الحية](../images/debug-javascript.png)
...
- **تشغيل الاختبار المحدد** بيصحّح method اختبار واحدة في كل لغة.
