...
**结果：**标记旁边会显示谁最后修改了这一行、多久以前、为什么：`Ada Lovelace，3 天前 · Fix the parser`。你还没有提交的行会这样说明，有未保存更改的文件会说明这一点，而不是报出错误的作者。点击这条提示可以看到整个文件的逐行作者，也可以在 GitHub 上打开这次提交或复制它的 ID；**视图 ▸ 行作者**可以把它关掉。
