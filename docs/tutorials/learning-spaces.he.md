...
3. **הקלידו ב‑REPL.** הראק המחווט מראש כולל מכשיר **REPL** שחוגת ה‑ENGINE שלו מכוונת לשפת המרחב (26 מנועים, ולכל אחד דגלים מוגדרים מראש שמכריחים מצב אינטראקטיבי). הקלידו ביטוי ולחצו Enter — הפלט זורם אל מסך ה‑REPL. חסר מפרש? הכפתור **INSTALL** מתקין אותו מהראק.
