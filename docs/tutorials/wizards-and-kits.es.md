...
![El asistente del Kit de estándares: robots.txt, sitemap, manifiesto web, security.txt del RFC 9116 y humans.txt generados a partir de tus respuestas](../images/tabs/wizards-and-kits.png)
