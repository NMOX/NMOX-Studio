...
![ANVIL работает в стойке, и Студия контрактов сама к нему подключилась — сеть 31337, контракт в дереве артефактов с долей лимита размера EIP-170](../images/contract-studio.png)
