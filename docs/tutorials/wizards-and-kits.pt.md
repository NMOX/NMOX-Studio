...
![O assistente do Standards Kit — robots.txt, sitemap, web manifest, security.txt da RFC 9116 e humans.txt gerados a partir das suas respostas](../images/tabs/wizards-and-kits.png)
