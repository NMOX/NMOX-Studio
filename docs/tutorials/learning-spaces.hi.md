...
3. **REPL में टाइप करें।** पहले से जुड़े रैक में एक **REPL** डिवाइस है
   जिसकी ENGINE घुंडी स्पेस की भाषा पर सेट है (कैटलॉग की हर REPL भाषा के
   लिए एक इंजन, हर एक के force-interactive फ़्लैग पहले से भरे हुए)। कोई एक्सप्रेशन टाइप करें,
