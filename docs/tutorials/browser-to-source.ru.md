...
![Панель DOM в DevTools с выбранным на странице h1: «Выбрать элемент», «Открыть исходник» и «Изменить стиль…» рядом с живым деревом](../images/story-06-devtools-pick.png)
