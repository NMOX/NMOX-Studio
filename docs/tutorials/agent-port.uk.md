...
![Діалог Agent Port — кінцева точка на loopback, токен для цього запуску (у знімку замість нього заповнювач) і готова конфігурація клієнта для копіювання](../images/tabs/agent-port.png)
...
**Зробіть:** Інструменти ▸ **Agent Port (MCP)…** ▸ **Запустити**, потім
