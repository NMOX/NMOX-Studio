...
![ديالوج الـ Agent Port — نقطة الوصول على الـ loopback، والتوكن اللي بيتعمل مع كل تشغيل (قيمة وهمية في اللقطة دي)، وإعدادات العميل الجاهزة للنسخ](../images/tabs/agent-port.png)
...
**اعملوا:** أدوات ‏◂‏ **Agent Port ‏(MCP)…** ◂ **بدء**، وبعدين **نسخ الإعدادات**.
