...
![وضع العرض شغال: قالب Angular ونافذة Output الاتنين ‎+10 pt، وبيرجعوا زي ما كانوا بالظبط لما الوضع يتقفل](../images/presentation-mode.png)

![تبويب المحرر لوحده، اتحفظ بـ «حفظ لقطة شاشة المحرر…» بحجم مضاعف](../images/editor-screenshot-2x.png)
