...
![Режим презентации включён: шаблон Angular и окно Output увеличены на 10 пт и возвращаются ровно к прежнему размеру, когда режим выключают](../images/presentation-mode.png)

![Одна вкладка редактора, сохранённая через «Сохранить снимок редактора…» в двойном размере](../images/editor-screenshot-2x.png)
