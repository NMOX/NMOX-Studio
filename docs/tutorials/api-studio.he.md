...
![200 חי ב‑331ms — והלשונית תקנים נותנת ציון לכותרות האבטחה של התגובה](../images/api-studio.png)
...
7. **שאלו את KVASIR על תגובה בעייתית.** כשתגובה חוזרת לא כמו שצריך, לחצו **הסבר עם KVASIR…**. תיבת הסכמה אומרת קודם בדיוק מה ייצא מהמחשב שלכם — השיטה, הכתובת כש*ערכי* השאילתה ממוסכים, הסטטוס, כותרות בטוחות (כותרות ההרשאה כבר הוסרו ונספרו) וגוף מוגבל בגודלו — ושום דבר לא נשלח עד שתאשרו. סרבו, ושום דבר לא רץ; אשרו, וההסבר נפתח כשיחה שאפשר להמשיך לשאול בה.
