...
![Панель DOM у DevTools із вибраним на сторінці h1: «Вибрати елемент», «Відкрити джерело» і «Змінити стиль…» поряд із живим деревом](../images/story-06-devtools-pick.png)
