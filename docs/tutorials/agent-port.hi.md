...
![Agent Port संवाद — लूपबैक एंडपॉइंट, हर शुरुआत पर बनने वाला टोकन (इस शॉट में एक प्लेसहोल्डर), और कॉपी करने को तैयार क्लाइंट कॉन्फ़िग](../images/tabs/agent-port.png)
...
**करें:** उपकरण ▸ **Agent Port (MCP)…** ▸ **शुरू करें**, फिर **कॉन्फ़िग कॉपी करें**।
...
इसे अपने एजेंट की `.mcp.json` में पेस्ट कीजिए। टोकन सिर्फ़ उसी संवाद में
मौजूद रहता है — न कभी लॉग होता है, न सहेजा जाता है — और पोर्ट के साथ ही
ख़त्म हो जाता है। **Agent Port रोकें** उसे बंद करता है; IDE छोड़ना भी। जब तक वह
