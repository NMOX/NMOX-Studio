...
![Режим презентації ввімкнено: шаблон Angular і вікно Output обидва на +10 pt, точно відновлені, коли режим вимикається](../images/presentation-mode.png)

![Лише вкладка редактора, збережена командою «Зберегти знімок редактора…» у розмірі 2x](../images/editor-screenshot-2x.png)
