...
עוצר), ושתי היציאות מאפשרות לחווט אותו.
...
רחפו מעל כרטיס איך משתמשים שלו — זה הטקסט של `usage` שלכם, ובגלל זה
...
גררו כבל מ‑**OUT** של COUNTER אל **TAP** של MONITOR. לחצו שוב COUNT:
