...
![אולפן הבלוקים — פלטת החלקים, משטח העבודה עם שורש הרכיב, וה‑Custom Element שנוצר, עם מיפוי הקוד בלחיצה על חלק](../images/tabs/block-studio.png)
...
2. **הוסיפו בלוקים מהפלטה.** גררו בלוק **Element** (צומת DOM) ותנו לו טקסט; הוסיפו שדה **State**; הוסיפו **Listener** שמחליף class בלחיצה. רק קינונים חוקיים מותרים — משטח העבודה מראה מראש היכן מותר להניח, ודוחה את המקומות הלא חוקיים, גם בטעינה.
