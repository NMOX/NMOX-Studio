...
![חיבור SQLite, שאילתה, שורות חיות בטבלה — ושורת המצב נותנת את הסיבה הכנה כשטבלה זמינה לקריאה בלבד](../images/db-studio.png)
...
4. **ייצאו.** לחיצה ימנית על טבלה כלשהי ← **ייצוא כ‑CSV / ייצוא כ‑JSON**. ייצוא CSV מנטרל אוטומטית הזרקת נוסחאות לגיליונות אלקטרוניים.
