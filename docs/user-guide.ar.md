...
على macOS، استخدموا `nmox .` أو **ملف ◂ فتح مجلد…**. الـ *فتح باستخدام* (Open With) بتاع Finder وأيقونة الـ Dock مايقدروش يسلّموا مجلد لتطبيق Java موقّع بيشتغل بالطريقة اللي NMOX Studio بيشتغل بيها، فالتطبيق مابيعرضش نفسه هناك.
