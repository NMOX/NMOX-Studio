...
**شجرة الملفات** هي استوديو المشاريع (⇧⌘E). دوسوا كليك يمين على ملف أو مجلد، وهتلاقوا جديد، وقص، ونسخ، ولصق، وحذف، وإعادة التسمية، وكمان — زي الـ Explorer بتاع VS Code — **نسخ المسار**، و**نسخ المسار النسبي** (نسبةً للمشروع)، و**عرض في Finder** (**عرض في مستكشف الملفات** على Windows، و**فتح الفولدر اللي فيه** على Linux).
...
جنب الشارة، فيه ملاحظة أهدى بتجاوب على السؤال اللي بتسألوه أكتر حاجة: مين كتب السطر اللي المؤشر واقف عليه؟ النص `Ada Lovelace، من 3 أيام · Fix the parser` بيمشي ورا المؤشر، بلغتكم، والتلميح بتاعه بيقول الـ commit والتاريخ. الضغط عليه بيفتح تعليقات السطور للملف كله — نفس **تعليقات السطور** اللي الشارة بتعرضها. الملاحظة بتسأل git مرة واحدة لكل نسخة محفوظة من الملف، عمرها ما بتسأل وقت التشغيل ولا عن ملف برّه المستودع، ومابتقولش حاجة عن ملف git مش متابعه. والسطر اللي غيّرتوه ولسه ما عملتوش له commit بيظهر عليه **لسه ما اتعملوش commit**. وطول ما الملف فيه تغييرات مش محفوظة، الملاحظة بتعرض **كاتب السطر: فيه تغييرات مش محفوظة** بدل الاسم، لأن git بيقرا الملف زي ما هو محفوظ، والسطر 40 على الشاشة مش لازم يكون السطر 40 على الديسك؛ احفظوا والاسم يرجع. **عرض ◂ كاتب السطر** بيقفل الملاحظة ويفتحها.
