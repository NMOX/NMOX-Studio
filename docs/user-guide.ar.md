...
بعد الشارة، ‎`↑2 ↓1` هي الـ commits اللي في الفرع بتاعكم ومش في الـ upstream بتاعه (محتاجة push)، والعكس (محتاجة pull)، وبتظهر بس لما متبقاش صفر، وبس للفرع اللي ليه upstream. القايمة بتاعتها بتبدأ بـ **تبديل الفرع…** و**عمل commit…**، ودول الديالوجات بتاعة موديول git نفسه.
