...
الـ IDE بيحدّث نفسه: **أدوات ◂ الإضافات ◂ التحديثات** بتعرض موديولات أي إصدار أحدث. ثبّتوا، وأعيدوا التشغيل لما يطلب منكم، وخلاص — من غير ما تنزّلوا التطبيق كله من الأول. تنبيه بصراحة: بيئة تشغيل Java المدمجة والـ launcher مش بيتغيروا غير مع installer كامل، عشان كده في القفزات الكبيرة للمنصة التثبيت من جديد من ملف الإصدار لسه هو الطريق الصح.
...
![الراك متوجّه لموقع jQuery كلاسيكي — الإعداد الجاهز منصة الويب الكلاسيكي: MAESTRO، وCRATE، وDYNAMO (مقبض الـ TASK بتاعه قرأ الـ Gruntfile الحقيقي)، وIGNITION بيقدّم الموقع بشكل ثابت، وVITALS حارس الجودة](images/ar/task-rack.png)
...
- **الإعدادات الجاهزة** بتديكم في ضغطة واحدة راك كامل ومتوصّل — بوابة الشحن، وذكاء التطوير، ومسارات المونوريبو، وحلقة E2E، ومنصة LAMP، ومنصة Web3، ومراقبة التشغيل. **حفظ patch** بيكتب الراك جنب المشروع باسم `.nmoxrack.json`؛ ولما توجّهوا للمشروع ده تاني بيتحمّل. مفيش حاجة بتتحفظ غير لما تدوسوا عليه.
...
أدوات ◂ الخيارات ◂ خريطة المفاتيح (على macOS: ‏NMOX Studio ◂ Settings… ◂ خريطة المفاتيح) بيبدّل البروفايل كله: اختصارات الحركة والقص بتاعة Emacs في كل محرر، أو مجموعات Eclipse وIDEA، لو ذاكرة إيديكم هناك. كل اختصار في NMOX متسجّل في البروفايلات الخمسة كلها، فتبديل البروفايل عمره ما بيكلّفكم اختصارات الاستوديوهات.
