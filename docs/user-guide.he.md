...
אחרי השבב, ‎`↑2 ↓1` הם ה‑commits שיש בענף שלכם ואין ב‑upstream שלו (לדחיפה) ולהפך (למשיכה), והם מוצגים רק כשהם אינם אפס ורק לענף שיש לו upstream. התפריט שלו מתחיל ב‑**החלפת ענף…** וב‑**ביצוע commit…**, תיבות הדו‑שיח של מודול git עצמו.
