...
אפשר למסור ל‑NMOX Studio תיקייה גם בלי מסוף, והיא מקבלת כיוון באותה דרך:

- **macOS:** לחיצה ימנית על תיקייה ב‑Finder ובחירה ב‑NMOX Studio תחת **פתח באמצעות** (Open With), או גרירת התיקייה אל הסמל של NMOX Studio ב‑Dock. כמה תיקיות בבת אחת: הראשונה מקבלת כיוון ושורת המצב אומרת זאת, כי ה‑IDE עובד על תיקייה אחת בכל פעם. קובץ שנגרר אל הסמל נפתח בעורך.
