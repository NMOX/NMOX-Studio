...
ב‑macOS, השתמשו ב‑`nmox .` או ב‑**קובץ ◂ פתיחת תיקייה…**. ה‑*פתח באמצעות* (Open With) של Finder והסמל ב‑Dock אינם יכולים למסור תיקייה לאפליקציית Java חתומה שמופעלת כמו ש‑NMOX Studio מופעל, ולכן האפליקציה לא מציעה את עצמה שם.
