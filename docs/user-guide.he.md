...
כלים ◂ אפשרויות ◂ מיפוי מקשים (ב־macOS: ‏NMOX Studio ◂ Settings… ◂ מיפוי מקשים) מחליף את כל הפרופיל: קיצורי התנועה והגזירה של Emacs בכל עורך, או הסטים של Eclipse ושל IDEA, אם שם נמצא זיכרון השריר שלכם. כל קיצור של NMOX רשום בכל חמשת הפרופילים, כך שהחלפת פרופיל לעולם אינה עולה לכם בקיצורי האולפנים.
