...
Pagkatapos nito, ang `↑2 ↓1` ay ang mga commit na mayroon ang iyong sanga na wala sa upstream nito (ipu-push) at ang kabaligtaran (ipu-pull), ipinapakita lamang kapag hindi zero at para lamang sa sangang may upstream. Nagsisimula ang menu nito sa **Lumipat ng Branch…** at **I-commit…**, ang sariling mga dialog ng git module.
