...
Maibibigay mo rin ang isang folder sa NMOX Studio nang walang terminal, at itinututok ito sa parehong paraan:

- **macOS:** i-right-click ang isang folder sa Finder at piliin ang NMOX Studio sa ilalim ng **Open With**, o ihulog ang folder sa icon ng NMOX Studio sa Dock. Kapag maraming folder nang sabay, ang una ang itinututok at sinasabi iyon sa status line: isang folder lang ang pinagtatrabahuhan ng IDE sa isang pagkakataon. Ang file na inihulog sa icon ay bumubukas sa editor.
