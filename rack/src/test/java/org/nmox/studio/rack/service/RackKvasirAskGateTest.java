 ...
 */
class RackKvasirAskGateTest {

    private static String source() throws Exception {
        return Files.readString(Path.of(
                "src/main/java/org/nmox/studio/rack/service/RackKvasirAsk.java"));
    }
    ...
    void consentPrecedesTheWindow() throws Exception {
        ...
        int dialog = s.indexOf("new AskKvasirDialog");
    ...
    void perSendGateSurvives() throws Exception {
        ...
        assertThat(s).contains("new AskKvasirEngine");
    }
}
