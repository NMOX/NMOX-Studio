...
/**
 * The Ask KVASIR conversation window: one modeless dialog per selection,
...
public final class AskKvasirDialog {
    ...
    private static final RequestProcessor RP =
            new RequestProcessor("nmox-ask-kvasir", 3, true); // windows never block each other; per-conversation order is the engine lock
    ...
    public AskKvasirDialog(KvasirConversation convo, AskKvasirEngine engine) {
        this(convo, engine, KvasirClient.MODEL_HAIKU);
    }

    public AskKvasirDialog(KvasirConversation convo, AskKvasirEngine engine, String model) {
        this.convo = convo;
        this.engine = engine;
        this.model = model;
