...
public final class ClassicKit {
     ...
     */
    /**
     * The Gruntfile the kit would write for this project (v2.162.0) — the
     * docs forge stages a classic site with the kit's own file so DYNAMO's
     * TASK knob parses a real one. Reads the project's js directory only.
     */
    public static String gruntfileFor(File projectDir) {
        return gruntfile(detectJsDir(projectDir));
    }
