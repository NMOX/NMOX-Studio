...
/**
 * The pure core of Draft Commit Message with KVASIR — the git chip's
 ...
 */
public final class KvasirCommitMessage {

    private KvasirCommitMessage() {
    }
    ...
    public static String unwrapReply(String reply) {
        ...
        String fenced = KvasirEdit.extractFencedCode(trimmed);
