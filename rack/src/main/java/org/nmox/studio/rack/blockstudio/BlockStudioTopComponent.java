            ...
            try {
                ...
                if (!ok) {
                    DialogDisplayer.getDefault().notifyLater(new NotifyDescriptor.Message(
                            org.nmox.studio.core.util.PlainDialogs.plain("src/components/" + tag + ".js exists but was not generated by "
                            + "Block Studio — it will not be overwritten. Rename your component "
                            + "or move the file.", "Message"), NotifyDescriptor.WARNING_MESSAGE));
                }
            } catch (IOException ex) {
        ...
        RP.post(() -> {
            try {
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    DialogDisplayer.getDefault().notifyLater(new NotifyDescriptor.Message(
                            org.nmox.studio.core.util.PlainDialogs.plain(picked.getName() + " is not in the Block Studio dialect \u2014 "
                            + ex.getMessage() + ". Only files generated by Block Studio "
                            + "(or edited within its shapes) can be opened as blocks.", "Message"),
