...
public class RosettaDevice extends RackDevice {
    ...
    private static final String[] TOOLCHAINS = {
        "auto", "node", "rust", "go", "elixir", "erlang", "clojure", "swift", "dotnet", "dart", "scala", "haskell", "zig", "ocaml", "crystal", "maven", "gradle", "python", "ruby", "php", "make", "julia", "nim", "dlang", "racket", "elm", "rescript", "purescript", "vlang"};
