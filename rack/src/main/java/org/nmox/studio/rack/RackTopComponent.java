...
@Messages({
    ...
    "# {0} - how many devices were saved switched on; never shown for none",
    "RackTopComponent_importAtRest={0,choice,1#One device was saved switched on; it arrives at rest.|1<{0} devices were saved switched on; they arrive at rest.}",
