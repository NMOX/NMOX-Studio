...
/**
 * Complete with KVASIR, the pure half: the request (the code around the
 ...
 */
public final class KvasirComplete {
    ...
    public static String extractInsertion(String reply, String lineBeforeCaret) {
        String code = KvasirEdit.extractFencedCode(reply);
        if (code == null) {
            return null;
        }
