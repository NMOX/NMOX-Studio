...
/**
 * The rack's name law (v1.41.0, DeviceContractTest) over the Tests window (v2.76.0):
 ...
 */
class TestsWindowA11yContractTest {
    ...
    void everyButtonIsNamed() throws Exception {
        ...
        SwingUtilities.invokeAndWait(() -> {
            for (Container window : List.<Container>of(new TestsExplorerTopComponent())) {
