...
@MIMEResolver.ExtensionRegistration(displayName = "#LBL_HaxeGrammar_LOADER", mimeType = "text/x-haxe", extension = {"hx"}, position = 2449)
@org.openide.util.NbBundle.Messages("LBL_HaxeGrammar_LOADER=Haxe")
