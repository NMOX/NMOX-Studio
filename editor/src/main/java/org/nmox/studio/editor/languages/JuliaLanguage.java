...
/**
 * Julia as a first-class CSL language: the platform supplies the
 ...
 */
@LanguageRegistration(mimeType = "text/x-julia")
public class JuliaLanguage extends DefaultLanguageConfig {
