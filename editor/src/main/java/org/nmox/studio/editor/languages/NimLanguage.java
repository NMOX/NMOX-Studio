...
/**
 * Nim as a first-class CSL language: the platform supplies the
 ...
 */
@LanguageRegistration(mimeType = "text/x-nim")
public class NimLanguage extends DefaultLanguageConfig {
