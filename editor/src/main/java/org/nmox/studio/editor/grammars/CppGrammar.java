...
@MIMEResolver.ExtensionRegistration(displayName = "#LBL_CppGrammar_LOADER", mimeType = "text/x-cpp", extension = {"cpp", "cc", "cxx", "hpp", "hh"}, position = 2040)
@org.openide.util.NbBundle.Messages("LBL_CppGrammar_LOADER=Cpp")
