...
/**
 * Zig as a first-class CSL language: the platform supplies the
 ...
 */
@LanguageRegistration(mimeType = "text/x-zig")
public class ZigLanguage extends DefaultLanguageConfig {
