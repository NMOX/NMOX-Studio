...
/**
 * Crystal as a first-class CSL language: the platform supplies the
 ...
 */
@LanguageRegistration(mimeType = "text/x-crystal")
public class CrystalLanguage extends DefaultLanguageConfig {
