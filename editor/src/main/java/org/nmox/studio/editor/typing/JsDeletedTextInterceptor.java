...
public class JsDeletedTextInterceptor implements DeletedTextInterceptor {
    ...
    @MimeRegistrations({
        ...
        @MimeRegistration(mimeType = "text/x-gleam", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-nim", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-d", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-racket", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-elm", service = DeletedTextInterceptor.Factory.class),
        ...
        @MimeRegistration(mimeType = "text/x-aiken", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-tact", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-vyper", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-clarity", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-move", service = DeletedTextInterceptor.Factory.class),
        ...
        @MimeRegistration(mimeType = "text/x-tcl", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-scheme", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-ada", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-pascal", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-odin", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-wit", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-cobol", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-haxe", service = DeletedTextInterceptor.Factory.class),
        @MimeRegistration(mimeType = "text/x-janet", service = DeletedTextInterceptor.Factory.class),
