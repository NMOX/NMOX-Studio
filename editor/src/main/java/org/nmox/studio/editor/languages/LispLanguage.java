...
/**
 * Common Lisp as a first-class CSL language: the platform supplies the
 ...
 */
@LanguageRegistration(mimeType = "text/x-lisp")
public class LispLanguage extends DefaultLanguageConfig {
