...
/**
 * ReScript as a first-class CSL language: the platform supplies the
 ...
 */
@LanguageRegistration(mimeType = "text/x-rescript")
public class ReScriptLanguage extends DefaultLanguageConfig {
