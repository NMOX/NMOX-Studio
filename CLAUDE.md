...
- **v1.65.1**: review fix — Project Studio's file tree survives a tab close/reopen (dispose no longer stops the reused panel's RequestProcessor, which had left the reopened tree stuck at "No project"; latent in the old tree too, now caught via the RootResolver seam, mutation-proven)
