...
- **v1.65.0**: VELOCITY — the Vite console (47th device), mirroring NEXUS/HALO for the tool under most modern React/Vue/Svelte/Solid SPAs: DEV (serve + URL→SCOPE, READY/SERVING), BUILD (production bundle), PREVIEW (serves the built dist), and vite-vs-registry version currency. DeviceType FRAMEWORKS entry, CI-step capable, FrameworkDeviceTest coverage, devices.md regenerated; IGNITION still serves Vite generically for the un-opinionated case
