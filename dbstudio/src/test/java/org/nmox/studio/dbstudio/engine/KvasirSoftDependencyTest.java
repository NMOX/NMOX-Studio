 ...
 */
class KvasirSoftDependencyTest {
    ...
    void stripIsGuardedByTheLookup() throws Exception {
        ...
        int guard = source.indexOf("KvasirAsk.find() != null");
    ...
    void stripOnlyOnError() throws Exception {
        ...
        assertThat(source).contains("result.isError() && org.nmox.studio.core.spi.KvasirAsk.find()");
    }
